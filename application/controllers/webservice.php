...
//  $this->webservice_model->user_apk_notification($register_userid, $user_message_apk);
  ...
  if($user_r[0]['device_type'] == 1){
      if($user_r[0]['device_token']){
          $this->ios_notification($user_r[0]['device_token'],$user_message_apk,'','Tienes nueva valoraci贸n y rese帽a','new rating review'); 
      }
  }else{
        $this->webservice_model->user_apk_notification($register_userid, $user_message_apk);  
  }
...
$passphrase = '';
  ...
  // end class
    ...
    function get_banner(){
     ...
     function addProductNotification($user_id = null , $user_name ,$product_name = 'ít'){
