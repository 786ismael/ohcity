...
<?php 
      ...
      $userList = $this->admin_common_model->get_all('banner');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Banner </span> <a href="<?=base_url('admin/view_page/addBanner');?>">
          <!--<button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>-->
        ...
        <tbody>
           <?php $i=2; foreach($userList as $row){ 
               ...
               ?>
                ...
                <tr>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div>
                        <span>
                            <a href="<?=base_url('admin/view_page/addBanner/'.$row['id']);?>" class="cdG">Edit</a></span>  
                        <span>
                            <!--<a href="#" class="cdG" onclick="deleteUsers('<?=$row["id"];?>')">Delete</a></span>-->
                        </div>
                    </div><!-- /row -->
                ...
                <td>
                                                <a href="<?=base_url('admin/view_page/addBanner/'.$row['id']);?>" class="cdG"><?=  $row['description']; ?></a></span>
