...
<?php include 'include/header.php';
      ...
      $issueList = $this->admin_common_model->get_where('report_issue_categories',[delete_status=>'no']);
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Issues </span> <a href="<?=base_url('admin/view_page/addIssue');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <div class="box-body table-responsive no-padding ">
        ...
        <tbody>
           <?php $i=2; foreach($issueList as $row){ 
               
               ?>

                <tr>
                 <td><p><?= $row['id']; ?></p></td>
                 <td><p><?= $row['issue_type']; ?></p></td>
                 <td style="min-width:25em">
                 <div class="row">
                  
                    <div class="col-sm-10">
                    <sapn><?= $row['category_name']; ?>
                        <div>
                        <span><a href="<?=base_url('admin/view_page/addIssue/'.$row['id']);?>" class="cdG">Edit</a> | </span>  
                        <span><a href="#" class="cdG" onclick="deleteIssue('<?=$row["id"];?>')">Delete</a></span>
                        </div>
                    </sapn></div><!-- /row -->
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'report_issue_categories', 'id': id}, // change this to send js object
          type: "POST",
