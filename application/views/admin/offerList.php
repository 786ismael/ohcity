...
<?php include 'include/header.php';
      ...
      $userList = $this->admin_common_model->get_all('offers');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Offers </span> <a href="<?=base_url('admin/view_page/addOffer');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
               ...
               ?>
                ...
                <!--<td><div class="[ form-group ] mb0">
                  ...
                  <div class="row">
                    ...
                    <sapn><?= $row['name']; ?>
                        <div>
                        <span><a href="<?=base_url('admin/view_page/addOffer/'.$row['id']);?>" class="cdG">Edit</a> | </span>  
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'offers', 'id': id}, // change this to send js object
          type: "POST",
