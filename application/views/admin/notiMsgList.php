...
<?php include 'include/header.php';
      ...
      $userList = $this->admin_common_model->get_all('notification_msg');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Notification Message </span>   
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      $Lessee_username = $this->admin_common_model->get_where('users',['id'=>$row['user_id']]);
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'notification_msg', 'id': id}, // change this to send js object
          type: "POST",
