...
<?php include 'include/head.php';
      ...
      if($id!=''){
        $fetch = $this->admin_common_model->get_where('offers',['id'=>$id]);
        $row = $fetch[0];
        $button = "update";
   ...
   <div class="col-sm-12 cdG">
         ...
         <div class="form-group">
            ...
            <div class="col-sm-8">
             ...
             <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Offer Status</label>
            <div class="col-sm-8">
...
$result = $this->admin_common_model->insert_data('offers',$arr_data); 
...
$('.confirm').click(function(){
        window.location='".base_url('admin/view_page/offerList')."';
});
...
$result = $this->admin_common_model->update_data('offers',$arr_data, $arr_where); 
//echo $this->db->last_query(); die;
