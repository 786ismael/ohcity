...
<?php include 'include/header.php';
      ...
      $productList = $this->admin_common_model->get_where('product',[promoting_status=>'yes']);
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG"> Promoting Products List </span><!-- <a href="<?=base_url('admin/view_page/AdNwProduct');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
-->
      ...
      <div class="box-body table-responsive no-padding ">
        ...
        <tbody>
           <?php $i=2; foreach($productList as $row){ 
                     ...
                     $category = $this->admin_common_model->get_where('category',['id'=>$row['cat_id']]);
                ...
                <!--<td><div class="[ form-group ] mb0">
                  ...
                  <div class="row">
                    ...
                    <sapn><?= $row['product_name']; ?>
                        <div>
                       <!-- <span><a href="<?=base_url('admin/view_page/AdNwProduct/'.$row['id']);?>" class="cdG">Promoting</a> | </span>
               ...
               <td> <div class="col-sm-2">
                       <?php
                        if ($user[0]['image'] == ''){
                          ...
                          $img_url = base_url('uploads/images/'.$user[0]['image']);
                        }
                      ?>
                      <img src="<?=$img_url;?>" alt="" width="60"> 
                    </div><!-- col-sm-2 --></td>
 
                <td><p><?= $category[0]['category_name']; ?></p></td>
                    ...
                    <td> <div class="col-sm-2">
                       <?php
                        if ($row['image1'] == ''){
                          ...
                          $img_url = base_url('uploads/images/'.$row['image1']);
                        }
                      ?>
                      <img src="<?=$img_url;?>" alt="" width="60"> 
                    </div><!-- col-sm-2 --></td>
                    <td> <div class="col-sm-2">
                       <?php
                        if ($row['image2'] == ''){
                          ...
                          $img_url = base_url('uploads/images/'.$row['image2']);
                        }
                      ?>
                      <img src="<?=$img_url;?>" alt="" width="60"> 
                    </div><!-- col-sm-2 --></td>
                    ...
                    <td> <div class="col-sm-2">
                       <?php
                        if ($row['image3'] == ''){
                          ...
                          $img_url = base_url('uploads/images/'.$row['image3']);
                        }
                      ?>
                      <img src="<?=$img_url;?>" alt="" width="60"> 
                    </div><!-- col-sm-2 --></td>
