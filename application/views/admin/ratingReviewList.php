...
<?php include 'include/header.php';
      ...
      $userList = $this->admin_common_model->get_all('review_rating');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Rating Review </span>   
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'review_rating', 'id': id}, // change this to send js object
          type: "POST",
