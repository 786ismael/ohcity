...
<?php include 'include/header.php';
      ...
      $userList = $this->admin_common_model->get_all('product');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">Products </span> 
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      $category = $this->admin_common_model->get_where('category',['id'=>$row['category_id']]);
               ...
               ?>
                ...
                <td><p><?= $row['price']; ?></p></td>
                <td><p><?= $row['price_type']; ?></p></td>

                <td><p> <div class="col-sm-2">
                       <?php
                        if ($row['image'] == ''){
