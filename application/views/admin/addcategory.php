  ...
  <div class="content-wrapper">
   ...
   <div class="col-sm-12 cdG">
          ...
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Catergory Name</label>
            <div class="col-sm-8">
...
$result = $this->admin_common_model->insert_data('category',$arr_data); 
...
$('.confirm').click(function(){
        window.location='".base_url('admin/view_page/categoryList')."';
});
...
$result = $this->admin_common_model->update_data('category',$arr_data, $arr_where); 
//echo $this->db->last_query(); die;
