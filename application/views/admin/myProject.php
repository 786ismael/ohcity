...
<?php 
 ...
 $myProject = $this->admin_common_model->get_all('myProjects');
...
?>
  ...
  <div class="content-wrapper" style="margin-left: 0;">
    ...
    <form action="" method="POST" id="bulk_form">
      ...
      <span class="fs30 cdG">My Projects </span> <a href="<?=base_url('admin/view_page/addMyProject');?>"><button type="button" class=" btn  btn-info-add btn-md mt-10 ml10" > Add New</button></a>
  ...
  <div class="tab-content">
    ...
    <th>Project Status</th>
        ...
        <tbody>
           <?php $i=1; foreach($myProject as $row){ 
...
<td><?= $row['id']; ?></td>
                  ...
                  <div class="row">
                   ...
                   <?= $row['project_name']; ?>
                        <div>
                        <span><a href="<?=base_url('admin/view_page/addMyProject/'.$row['id']);?>" class="cdG">Edit</a> | </span>  
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'myProjects', 'id': id}, // change this to send js object
          type: "POST",
