...
<div class="col-md-6  col-sm-6 sign-in" style="padding: 30px;
	...
	<form class="register-form outer-top-xs" method="post" role="form" action="<?php echo base_url('home/user_signup');?>">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input type="tel" id="phone" name="phone" class="form-control unicase-form-control text-input inpt">
		    <span class="text-danger" style="color: red;"><?php echo form_error('phone'); ?></span>
		</div>
	...
	<div class="form-group">
		...
		<div class="form-group">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button btn-login-20">Sign Up</button>
